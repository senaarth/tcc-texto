...
\todo[inline, color=pink]{Está vendo que aqui aparece o estudo do Larsen et al. De qualquer maneira, está superficial. Como eu havia comentado antes,  aqui você precisaria resumir alguns dos principais problemas relatados nesse estudo e deixando claro que ele é uma boa referência para discussão de problemas estatísticos em teste A/B. As questões discutidas nesse estudo sãO importantíssimas! }

\todo[inline, color=pink]{Além da questão anterior, reescrev esse parágrafo citando os estudos associados aos problemas específicos. Não da forma como está todas as citações ao final do parágrafo. Esse problema não ocorre só neste parágrafo }
