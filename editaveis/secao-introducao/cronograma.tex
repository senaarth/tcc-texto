...
Esta subseção visa apresentar as atividades realizadas na segunda etapa deste trabalho,
...
\begin{figure}[h!]
    \caption{Fluxo de Atividades Realizadas na Segunda Etapa da Monografia}
    \centering
...
\begin{figure}[h!]
    \caption{Cronograma Realizado na Segunda Etapa da Monografia}
    \centering
...
\begin{itemize}
    ...
    \item \textbf{Desenvolvimento e Coleta de Dados:} desenvolvimento da nova versão de \textit{software} (tratamento) a ser comparada com a versão já existente (controle); liberação da nova versão para os usuários beta a fim de iniciar a iteração do experimento (a coleta de dados já deve acontecer a partir desta liberação);
