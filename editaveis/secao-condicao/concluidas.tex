...
\begin{table}[ht]
\centering
    \caption{Condição das Atividades do Trabalho}
    \begin{tabular}{|p{9.5cm}|p{2cm}|p{3cm}|}
        \hline
        \textbf{Atividade} & \textbf{Condição} & \textbf{Resultados} \\ \hline
        Contextualização em Experimentação na Engenharia de \textit{Software} & Concluída & Seção \ref{subsec:experimentacao} \\ \hline
        ...
        Apresentação do TCC 1 & Concluída & - \\ \hline
        Evolução do Trabalho a Partir das Considerações da Banca & Concluída & - \\ \hline
        Execução do Estudo de Caso & Concluída & Capítulo \ref{subsec:execucao} \\ \hline
        Coleta de Opinião dos Envolvidos & Concluída & Seção \ref{subsec:opiniao} \\ \hline
        Análise dos Resultados & Concluída & Capítulo \ref{subsec:resultados} \\ \hline
        Incremento da Monografia & Concluída & - \\ \hline
        Apresentação do TCC 2 & Agendada & - \\ \hline
    \end{tabular}
