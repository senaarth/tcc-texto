...
A avaliação da qualidade em uso por meio de métricas quantitativas apresenta desafios, dada a sua natureza subjetiva \cite{qatch, fabijan_three_2019}. Embora as métricas adotadas sejam baseadas em modelos de referência, não foi possível abranger todas as características subcaracterísticas de qualidade em uso, o que seria ideal para uma avaliação mais abrangente e assertiva.
...
Devido às restrições do cronograma deste trabalho de conclusão de curso, algumas etapas do processo proposto não puderam ser exploradas em profundidade. Entre elas, destaca-se a coleta de dados qualitativos sobre as versões do produto avaliadas, o que poderia fornecer informações adicionais para embasar a tomada de decisão (conforme descrito no Apêndice \ref{apdx:processo-novo}).

Além disso, todo o processo de análise estatística e liberação da versão escolhida foi conduzido manualmente, dado o contexto das ferramentas utilizadas e do volume de dados coletado. Estudos futuros podem explorar a automação dos procedimentos de análise e de \textit{release}, se utilizando de modelos de aprendizado de máquina integrados a rotinas de entrega contínua. Estas implementações poderiam levar o processo proposto à um ambiente de real execução contínua de diferentes experimentos, o que não aconteceu neste estudo, que utilizou de apenas um.
