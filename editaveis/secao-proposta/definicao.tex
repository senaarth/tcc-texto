...
Esses dados quantitativos devem caracterizar a qualidade em uso de cada versão, como definido pela norma \citeonline{nbr9241}. Para caracterizar a usabilidade do produto, serão utilizadas métricas como tempo despendido na atividade, número de atividades realizadas com sucesso, à depender do que se entende como sucesso da funcionalidade. Serão avaliadas diferentes subcaracterísticas de qualidade, como a satisfação, a eficácia e a eficiência. Desta forma, a seguir são apresentadas as questões específicas.

\begin{itemize}
    \item \textbf{Questão Específica 1.1:}  Durante o experimento, foi possível identificar diferença de usabilidade entre as versões de controle (A) e de tratamento (B) do produto, a partir de seu uso? 
    \begin{itemize}
        \item \textbf{Métrica 1.1:} Tempo de uso, quantidade de cliques, número de tarefas realizadas com sucesso. Métricas que representem a completude com a qual os objetivos dos usuários são alcançados, o nível de esforço desprendido e a extensão pela qual estão livres de desconforto ao utilizar o sistema (subcaracterísticas de qualidade em uso).
    \end{itemize}
