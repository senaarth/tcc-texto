...
\end{figure}
 ...
 \todo[inline, color=pink]{A qualidade desta imagem não está boa. Tratar isso}


\todo[inline, color=pink]{Aqualidade desta imagem não está boa. Tratar isso}
...
\todo[inline, color=pink]{Essa explicação não deveria estar aqui, mas na subção 4.1.4}
