...
Em seguida, o processo de desenvolvimento atual da empresa foi analisado, de forma a compreender as atividades já existentes e realizadas pelos desenvolvedores do produto, para posterior definição de atividades que viabilizariam a execução de experimentos controlados. Esta definição se baseou principalmente no processo \textit{Combined Process for Experimentation}, proposto por \citeonline{erthal_characterization_2023}, apresentado no Apêndice \ref{apdx:processo-erthal} \textcolor{blue}{Apêndice}\todo[color=yellow]{As Três/duas imganes precisam ser exepcificamente citadas.}.Finalizado esse mapeamento e utilizando os insumos encontrados na literatura, foi proposto um novo processo, visando a introdução de práticas de experimentação contínua. Este novo processo servirá de objeto de estudo desta monografia. A versão inicial, que ilustra o fluxo desenvolvimento atualmente utilizado pela empresa, é apresentado no Apêndice \ref{apdx:processo-antigo}. Já as atividades propostas neste trabalho, adaptadas a partir do processo atual, são apresentadas no Apêndice \ref{apdx:processo-novo} \textcolor{blue}{Apêndice}\todo[color=yellow]{As Três/duas imganes precisam ser exepcificamente citadas.}, onde os itens destacados de vermelho são as novas atividades e artefatos, trazendo o fluxo que deve ser seguido nesta investigação.
...
Aqui serão descritas as atividades, fases, papeis e artefatos do processo proposto. Determinadas atividades do processo são iterativas e devem/podem ser realizadas novamente caso necessário. Abaixo são descritas as atividades a serem realizadas, conforme apresentado no Apêndice \ref{apdx:processo-novo}.
